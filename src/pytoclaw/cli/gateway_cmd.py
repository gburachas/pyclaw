...
async def run_gateway(config_path: str | None = None) -> None:
    ...
    from pytoclaw.channels.base import ChannelManager
    from pytoclaw.cli.agent_cmd import _register_tools
    ...
    console.print(f"[bold]pytoclaw gateway[/bold] v{__version__}")
